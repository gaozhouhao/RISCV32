...
if {[info exists ::env(YOSYS_DEFINES)] && $::env(YOSYS_DEFINES) ne ""} {
  foreach define [split $::env(YOSYS_DEFINES)] {
    lappend yosys_defines "-D${define}"
  }
}

puts "YOSYS_DEFINES = $yosys_defines"

# read verilog files
foreach file $VERILOG_FILES {
  read_verilog -sv {*}$yosys_defines $file
}
